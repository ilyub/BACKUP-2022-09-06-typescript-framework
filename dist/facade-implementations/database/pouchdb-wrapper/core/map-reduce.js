...
function getMapReduce(options, queryOptions, caseSensitiveSorting) {
    ...
    const id = (0, sha256_1.default)(functions_1.json.encode([
        conds.toEmit,
        conds.toSettle,
        sortBy,
        descending,
  ...
  `);
    return {
        groupLevel: ((_b = queryOptions.count) !== null && _b !== void 0 ? _b : false) ? 1 : 3,
        id,
...
exports.getMapReduce = getMapReduce;
/**
 * Creates map/reduce function.
 *
 * @param options - Options.
...
function getMapReduceAttached(options, queryOptions, caseSensitiveSorting) {
  ...
  `);
    return {
        groupLevel: ((_b = queryOptions.count) !== null && _b !== void 0 ? _b : false) ? 1 : 4,
        id,
        mapReduce: { map, reduce },
...
exports.getMapReduceAttached = getMapReduceAttached;
/**
...
function condsToStr(source, conditions) {
    ...
    for (const group of conditions)
        for (const [key, field] of functions_1.o.entries(group)) {
 ...
 * @returns Delta.
 */
function dateDelta(date, offset) {
    return functions_1.num.round.step(facades_1.datetime.create(date).toTime() - facades_1.datetime.time() + offset, 3600 * 1000);
}
/**
