...
export const isDocsResponse = is.object.factory({ count: is.number, docs: isDocResponses, settled: is.boolean }, {});
...
export const isExistingAttachedDocument = is.object.factory({ _id: is.number, _rev: is.number, parentDoc: isExistingDocument }, { _deleted: is.true });
